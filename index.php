...
/**
 * List of all ejss simulations in course.
 *
 * @package    mod_ejsssimulation
 * @subpackage ejssstats
...
$event = \mod_ejsssimulation\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strresource     = get_string('modulename', 'ejsssimulation');
$strresources    = get_string('modulenameplural', 'ejsssimulation');
$strsectionname  = get_string('sectionname', 'format_'.$course->format);
$strname         = get_string('name');
$strintro        = get_string('moduleintro');
$strlastmodified = get_string('lastmodified');

$PAGE->set_url('/mod/ejsssimulation/index.php', array('id' => $course->id));
...
if (!$resources = get_all_instances_in_course('ejsssimulation', $course)) {
...
foreach ($resources as $resource) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('ejsssimulation', $resource, $cm->id));
}
